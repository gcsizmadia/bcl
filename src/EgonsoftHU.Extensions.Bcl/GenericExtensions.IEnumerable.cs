...
namespace EgonsoftHU.Extensions.Bcl
{
    public partial class GenericExtensions
    {
        ...
        /// <param name="values">A collection in which to locate a value.</param>
        /// <returns>Returns true if the specified collection contains an element that has the specified value; otherwise, false.</returns>
        public static bool IsIn<T>(this T? value, IEqualityComparer<T?>? equalityComparer, params IEnumerable<T?> values)
        {
            return
                equalityComparer is null
                    ? values.Contains(value)
        ...
        /// <param name="values">A collection in which to locate a value.</param>
        /// <returns>Returns true if the specified collection contains an element that has the specified value; otherwise, false.</returns>
        public static bool IsIn<T>(this T? value, params IEnumerable<T?> values)
        {
            return value.IsIn(equalityComparer: null, values);
        }
#endif
        ...
        /// <param name="values">A collection in which to locate a value.</param>
        /// <returns>Returns true if the specified collection contains an element that has the specified value; otherwise, false.</returns>
        public static bool IsIn<T>(this T value, IEqualityComparer<T>? equalityComparer, params ReadOnlySpan<T> values)
        ...
        /// <param name="values">A collection in which to locate a value.</param>
        /// <returns>Returns true if the specified collection contains an element that has the specified value; otherwise, false.</returns>
        public static bool IsIn<T>(this T value, params ReadOnlySpan<T> values)
            where T : IEquatable<T>
        {
            return value.IsIn(equalityComparer: null, values);
        }
        ...
        /// <param name="values">A collection in which to locate a value.</param>
        /// <returns>Returns true if the specified collection does not contain an element that has the specified value; otherwise, false.</returns>
        public static bool IsNotIn<T>(this T? value, IEqualityComparer<T?>? equalityComparer, params IEnumerable<T?> values)
        {
            return !value.IsIn(equalityComparer, values);
        }
        ...
        /// <param name="values">A collection in which to locate a value.</param>
        /// <returns>Returns true if the specified collection does not contain an element that has the specified value; otherwise, false.</returns>
        public static bool IsNotIn<T>(this T? value, params IEnumerable<T?> values)
        {
            return !value.IsIn(equalityComparer: null, values);
        }
#endif
        ...
        /// <param name="values">A collection in which to locate a value.</param>
        /// <returns>Returns true if the specified collection does not contain an element that has the specified value; otherwise, false.</returns>
        public static bool IsNotIn<T>(this T value, IEqualityComparer<T>? equalityComparer, params ReadOnlySpan<T> values)
            where T : IEquatable<T>
        {
            return !value.IsIn(equalityComparer, values);
        }
        ...
        /// <param name="values">A collection in which to locate a value.</param>
        /// <returns>Returns true if the specified collection does not contain an element that has the specified value; otherwise, false.</returns>
        public static bool IsNotIn<T>(this T value, params ReadOnlySpan<T> values)
            where T : IEquatable<T>
        {
            return !value.IsIn(equalityComparer: null, values);
        }
